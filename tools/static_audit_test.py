...
# ============================================================
# 近五日主要事件机制验证（v1.71 起字段取消输出，验证其确已移除）
# ============================================================
...
def test_recent_events():
    ...
    # 验证：近五日主要事件字段已从 2-3 移除
    test("RE-1", "近五日主要事件字段已从 2-3 移除",
         "近五日主要事件" not in f_23,
         "v1.71 取消该字段输出；若出现说明旧规则复活")

    # 验证：近五日主要事件字段已从 2-1 移除
    test("RE-2", "近五日主要事件字段已从 2-1 移除",
         "近五日主要事件" not in f_21,
         "v1.71 取消该字段输出；若出现说明旧规则复活")
