...
1d. Current Month 由 WSK 从 WM 的 Day 确定性推导（非独立推算时间推进）：D1-D31=10月，D32-D61=11月，D62-D92=12月（冬开始），D93-D120=1月，D121-D151=2月，D152-D181=3月（春开始）；Current Season 信任 WM 在 `[主要状态]` 中输出的值。
